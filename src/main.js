...
document.querySelector('#app').innerHTML = `
  ...
  <h1 class=" ml-2 mr-2 mt-12 text-2xl bg-white/15 p-2 rounded-xl text-violet-50 text-center "><strong>Programadora Web
      Frontend </strong></h1>
  <h1 class=" ml-2 mr-2 mt-1 text-xs p-1 rounded-xl text-emerald-50 text-center "><strong>Licenciada en Pedagogia
      General de la Música <br> Conservatorio Superior del Liceo</strong></h1>
...
>
  <path
    d="M33.5 12.7a9.3 9.3 0 0 1-3.2-7.1h-5.1v24a4.4 4.4 0 1 1-4.4-4.4
...
>
  <path
    d="M12 19h5.3v17H12zM14.6 12a3.1 3.1 0 1 1 0 6.2 3.1 3.1 0 0 1 0-6.2zM20.6 19h5v2.3
...
<div class="mt-10">
  ...
  <div class="pulsate-bck-normal ml-2 mr-2 mb-4 p-1 rounded-xl flex justify-center justify-items-center place-items-center mt-2 h-12  bg-slate-50/25">
    <img src="Screenshot_20251018_130052_TikTok.jpg" class="h-10 w-10 object-contain rounded-xl"/>
    <a href="https://81andie.github.io/my-portfolio/"><p class="text-2xl font-bold text-violet-100 text-center">PORTFOLIO</p></a>
  </div>

   <div class="scale-up-bottom-normal ml-2 mr-2 p-1 mb-4 rounded-xl flex justify-center justify-items-center place-items-center mt-2 h-12  bg-slate-50/25">
    <img src="Galaxy-Fold2-localhost (8).png" class="h-10 w-10  rounded-xl object-contain "/>
    <a href="https://fiori-jxm6.vercel.app/#/inicio"><p class="text-2xl font-bold text-violet-100 text-center">Fiori Poetic Blog</p></a>
  </div>
